...
int main()
{
    string apprentissage="/Users/hugotouvron/Desktop/apprentissage10.csv";
    string test="/Users/hugotouvron/Desktop/test10.csv";
    int NombreAuteur=10;
    int k=5;
    int nombreAlgo=1;
    double res[NombreAuteur];
    ExecutionML(apprentissage, test,NombreAuteur,res);
    double * res2 [1];
    res2[0]=res;
    double ProbaK[k];
    int AuteurK[k];

    Ensemble(res2,nombreAlgo,NombreAuteur,k,AuteurK,ProbaK);
